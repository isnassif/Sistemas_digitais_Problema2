...
<p>
  ...
  1. Envio do comando de instrução:
O HPS escreve o código da operação desejada (opcode) no registrador de controle (CONTROL_PIO_ptr), determinando qual algoritmo de processamento deve ser executado pela FPGA.
</p>
